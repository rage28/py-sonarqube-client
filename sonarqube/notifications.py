...
class SonarQubeNotification(object):
    ...
    def user_list_notifications(self, login):
        ...
        resp = self.sonarqube._make_call('get', API_NOTIFICATIONS_LIST, **params)
        data = resp.json()
    ...
    def user_add_notifications(self, login, type, **kwargs):
        ...
        self.sonarqube._make_call('post', API_NOTIFICATIONS_ADD, **params)
    ...
    def user_remove_notifications(self, login, type, **kwargs):
        ...
        self.sonarqube._make_call('post', API_NOTIFICATIONS_REMOVE, **params)
