...
class SonarQubeProject_Branches(object):
    ...
    def get_project_branches_list(self, project):
        ...
        resp = self.sonarqube._make_call('get', API_PROJECT_BRANCHES_LIST, **params)
        data = resp.json()
    ...
    def delete_project_branch(self, project, branch):
        ...
        self.sonarqube._make_call('post', API_PROJECT_BRANCHES_DELETE, **params)
    ...
    def rename_project_branch(self, project, name):
        ...
        self.sonarqube._make_call('post', API_PROJECT_BRANCHES_RENAME, **params)
