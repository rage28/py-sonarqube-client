...
class SonarQubeCe(object):
    ...
    def get_ce_activity(self, **kwargs):
        ...
        resp = self.sonarqube._make_call('get', API_CE_ACTIVITY, **params)
        data = resp.json()
    ...
    def get_ce_component(self, component):
        ...
        resp = self.sonarqube._make_call('get', API_CE_COMPONENT, **params)
        return resp.json()
    ...
    def get_ce_task(self, **kwargs):
        ...
        :return:
        """
        resp = self.sonarqube._make_call('get', API_CE_TASK, **kwargs)
        return resp.json()
