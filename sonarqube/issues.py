...
class SonarQubeIssue(object):
    ...
    def issue_assign(self, issue_keys, assignee):
        ...
        if isinstance(issue_keys, list):
            for issue_key in issue_keys:
                ...
                self.sonarqube._make_call('post', API_ISSUES_ASSIGN, **params)
    ...
    def issue_set_severity(self, issue, severity):
        ...
        self.sonarqube._make_call('post', API_ISSUE_SET_SEVERITY, **params)
    ...
    def issue_set_type(self, issue, type):
        ...
        self.sonarqube._make_call('post', API_ISSUE_SET_TYPE, **params)
    ...
    def issue_add_comment(self, issue, text):
        ...
        self.sonarqube._make_call('post', API_ISSUE_ADD_COMMENT, **params)
    ...
    def issue_delete_comment(self, comment):
        ...
        self.sonarqube._make_call('post', API_ISSUE_DELETE_COMMENT, **params)
    ...
    def issue_edit_comment(self, comment, text):
        ...
        self.sonarqube._make_call('post', API_ISSUE_EDIT_COMMENT, **params)
    ...
    def issues_do_transition(self, issue_keys, transition):
        ...
        if isinstance(issue_keys,list):
            for issue_key in issue_keys:
                params['issue'] = issue_key
                self.sonarqube._make_call('post', API_ISSUES_DO_TRANSITION, **params)
        elif isinstance(issue_keys,str):
            params['issue'] = issue_keys
            self.sonarqube._make_call('post', API_ISSUES_DO_TRANSITION, **params)
    ...
    def get_issues_author(self, project, q=None):
        ...
        if q:
            params['q'] = q
        resp = self.sonarqube._make_call('get', API_ISSUES_AUTHORS, **params)
        response = resp.json()
